...
{
    public class ApiPatchServices<T, R>(HttpClient httpClient, 
        IAuthenticationServices authenticate)
     : IApiPatchServices<T, R>
    {
        ...
        public async Task<Result<T>> PatchAsync(string url, R FormData, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                //    && typeof(R) != typeof(GetOTPRequest)
                //    && typeof(R) != typeof(ResendOTPRequest)
                //    && typeof(R) != typeof(LoginRequest)
                //     && typeof(R) != typeof(LogoutUserRequest)
