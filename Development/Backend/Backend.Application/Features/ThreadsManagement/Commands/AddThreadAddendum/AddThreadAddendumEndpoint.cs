...
[Route(BaseApiPath + "/threads/add/addendum")]
public class ThreadController : BaseController
{
    ...
    public async Task<ActionResult> AddThreadAddendum(
        [FromBody] AddThreadAddendumRequest request,
        CancellationToken cancellationToken
        )
    {
        var command = Mapper.Map<AddThreadAddendumCommand>(request);
