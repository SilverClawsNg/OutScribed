...
[Route(BaseApiPath + "/tales/update/photo")]
public class TaleController : BaseController
{
    ...
    public async Task<ActionResult> UpdateTalePhoto(
        [FromBody] UpdateTalePhotoRequest request,
        CancellationToken cancellationToken
        )
    {
        var command = Mapper.Map<UpdateTalePhotoCommand>(request);
