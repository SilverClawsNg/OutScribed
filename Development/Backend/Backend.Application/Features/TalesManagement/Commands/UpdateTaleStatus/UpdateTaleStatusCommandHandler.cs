...
{
    public class UpdateTaleStatusCommandHandler(IUnitOfWork unitOfWork, IErrorLogger errorLogger)
        : IRequestHandler<UpdateTaleStatusCommand, Result<bool>>
    {

        private readonly IUnitOfWork _unitOfWork = unitOfWork;
        private readonly IErrorLogger _errorLogger = errorLogger;

        public async Task<Result<bool>> Handle(UpdateTaleStatusCommand request, CancellationToken cancellationToken)
        {
            //Validate request
            var validator = new UpdateTaleStatusCommandValidator();
