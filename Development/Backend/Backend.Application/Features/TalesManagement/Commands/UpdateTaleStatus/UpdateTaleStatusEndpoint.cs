...
[Route(BaseApiPath + "/tales/update/status")]
public class TaleController : BaseController
{
    ...
    public async Task<ActionResult> UpdateTaleStatus(
        [FromBody] UpdateTaleStatusRequest request,
        CancellationToken cancellationToken
        )
    {
        var command = Mapper.Map<UpdateTaleStatusCommand>(request);
