...
//            Tale? tale_tiger = await _unitOfWork.TaleRepository.GetTaleById(Guid.Parse("3f44fa2d-e685-4476-823b-edd6788ce912"));
...
//            Tale? tale_deal = await _unitOfWork.TaleRepository.GetTaleById(Guid.Parse("fd568dab-3cad-418f-9d08-2662f5813dd1"));
...
//            Tale? tale_king = await _unitOfWork.TaleRepository.GetTaleById(Guid.Parse("c40ff37b-4a83-412f-bf61-74c315d26a91"));
...
//            Tale? tale_overlord = await _unitOfWork.TaleRepository.GetTaleById(Guid.Parse("4261321b-0b36-417a-8fc0-9dc25e2f02c5"));
...
//            Tale? tale_constitution = await _unitOfWork.TaleRepository.GetTaleById(Guid.Parse("129d6a3d-4731-48b6-8192-8c031c3dd5e0"));
...
//            Tale? tale_trump = await _unitOfWork.TaleRepository.GetTaleById(Guid.Parse("4261321b-0b36-417a-8fc0-9dc25e2f02c5"));
...
//            Tale? tale_duckling = await _unitOfWork.TaleRepository.GetTaleById(Guid.Parse("45fee8f8-bb13-45ff-8e36-fa33037e36b5"));
