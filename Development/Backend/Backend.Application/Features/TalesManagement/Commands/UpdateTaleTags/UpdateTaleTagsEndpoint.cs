...
[Route(BaseApiPath + "/tales/update/tags")]
public class TaleController : BaseController
{
    ...
    public async Task<ActionResult> UpdateTaleTags(
        [FromBody] UpdateTaleTagsRequest request,
        CancellationToken cancellationToken
        )
    {
        var command = Mapper.Map<UpdateTaleTagsCommand>(request);
