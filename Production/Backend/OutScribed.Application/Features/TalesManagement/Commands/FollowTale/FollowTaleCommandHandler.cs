...
{
    public class FollowTaleCommandHandler(IUnitOfWork unitOfWork, IErrorLogger errorLogger)
        : IRequestHandler<FollowTaleCommand, Result<FollowTaleResponse>>
    {

        private readonly IUnitOfWork _unitOfWork = unitOfWork;
        private readonly IErrorLogger _errorLogger = errorLogger;
      
        public async Task<Result<FollowTaleResponse>> Handle(FollowTaleCommand request, CancellationToken cancellationToken)
        {

            //Validate request
            var validator = new FollowTaleCommandValidator();
