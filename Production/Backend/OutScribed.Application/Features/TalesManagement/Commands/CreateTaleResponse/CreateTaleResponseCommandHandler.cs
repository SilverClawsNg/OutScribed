...
{
    public class CreateTaleResponseCommandHandler(IUnitOfWork unitOfWork, IErrorLogger errorLogger)
        : IRequestHandler<CreateTaleResponseCommand, Result<CreateTaleResponseResponse>>
    {

        private readonly IUnitOfWork _unitOfWork = unitOfWork;
        private readonly IErrorLogger _errorLogger = errorLogger;
      
        public async Task<Result<CreateTaleResponseResponse>> Handle(CreateTaleResponseCommand request, CancellationToken cancellationToken)
        {

            //Validate request
            var validator = new CreateTaleResponseCommandValidator();
            ...
            try
            {
                ...
                //Return success
                return new CreateTaleResponseResponse
                {
