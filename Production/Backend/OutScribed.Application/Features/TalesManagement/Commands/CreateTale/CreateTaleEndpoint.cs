...
[Route(BaseApiPath + "/tales/create")]
public class TaleController : BaseController
{
    ...
    public async Task<ActionResult> CreateTale(
        [FromBody] CreateTaleRequest request,
        CancellationToken cancellationToken
        )
    {
        var command = Mapper.Map<CreateTaleCommand>(request);
