...
[Route(BaseApiPath + "/tales/update/summary")]
public class TaleController : BaseController
{
    ...
    public async Task<ActionResult> UpdateTaleSummary(
        [FromBody] UpdateTaleSummaryRequest request,
        CancellationToken cancellationToken
        )
    {
        var command = Mapper.Map<UpdateTaleSummaryCommand>(request);
