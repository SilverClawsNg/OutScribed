...
{
    [Route(BaseApiPath + "/accounts/send/registration/otp/phone")]
    public class AccountController : BaseController
    {
        ...
        public async Task<ActionResult> SendAccountActivationOTP(
            [FromBody] SendRegistrationOTPPhoneRequest request,
            CancellationToken cancellationToken
            )
        {
            var command = Mapper.Map<SendRegistrationOTPPhoneCommand>(request);
