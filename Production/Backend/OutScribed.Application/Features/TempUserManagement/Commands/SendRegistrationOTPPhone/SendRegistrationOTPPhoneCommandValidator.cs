...
{
    public class SendRegistrationOTPPhoneCommandValidator : AbstractValidator<SendRegistrationOTPPhoneCommand>
    {
        public SendRegistrationOTPPhoneCommandValidator()
        {
