...
[Route(BaseApiPath + "/accounts/create/email")]
public class AccountController : BaseController
{
    ...
    public async Task<ActionResult> CreateAccountEmail(
        [FromBody] CreateAccountEmailRequest request,
        CancellationToken cancellationToken
        )
    {
        var command = Mapper.Map<CreateAccountEmailCommand>(request);
