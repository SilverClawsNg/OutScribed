...
{
    public class UpdateThreadDetailsCommandHandler(IUnitOfWork unitOfWork, IErrorLogger errorLogger)
        : IRequestHandler<UpdateThreadDetailsCommand, Result<UpdateThreadDetailsResponse>>
    {

        private readonly IUnitOfWork _unitOfWork = unitOfWork;
        private readonly IErrorLogger _errorLogger = errorLogger;

        public async Task<Result<UpdateThreadDetailsResponse>> Handle(UpdateThreadDetailsCommand request, CancellationToken cancellationToken)
        {
            //Validate request
            var validator = new UpdateThreadDetailsCommandValidator();
            ...
            //upgrade guest
            var result = thread.UpdateDetails(
                request.Details);
            ...
            try
            {
                ...
                return new UpdateThreadDetailsResponse()
                {
