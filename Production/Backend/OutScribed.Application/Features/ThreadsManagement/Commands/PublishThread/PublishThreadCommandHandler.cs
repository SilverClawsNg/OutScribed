...
{
    public class PublishThreadCommandHandler(IUnitOfWork unitOfWork, IErrorLogger errorLogger)
        : IRequestHandler<PublishThreadCommand, Result<bool>>
    {

        private readonly IUnitOfWork _unitOfWork = unitOfWork;
        private readonly IErrorLogger _errorLogger = errorLogger;

        public async Task<Result<bool>> Handle(PublishThreadCommand request, CancellationToken cancellationToken)
        {
            //Validate request
            var validator = new PublishThreadCommandValidator();
